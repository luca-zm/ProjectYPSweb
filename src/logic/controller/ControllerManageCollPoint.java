...
public class ControllerManageCollPoint {	
	...
	public Boolean insert(CollectionPointBean collPointBean) throws IOException, SQLException { //Vuole eccezione personale
	    ...
	    Message m = new Message(0,getDate(), "Nuovo Punto di raccolta", "Aggiunto un nuovo punto di raccolta sulla mappa: " + name, MesType.COLLPOINTBROAD);
